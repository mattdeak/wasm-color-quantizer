...
function __wbg_adapter_28(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h09cf73a106909c04(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_33(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h70355f2cee0091f7(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_395(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h54e00a299b7bd240(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class ColorCruncher {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ColorCruncher.prototype);
        obj.__wbg_ptr = ptr;
        ColorCruncherFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    */
    quantizeImage(data) {
        ...
        const ret = wasm.colorcruncher_quantizeImage(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
}

const ColorCruncherBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_colorcruncherbuilder_free(ptr >>> 0));
/**
*/
export class ColorCruncherBuilder {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ColorCruncherBuilder.prototype);
        obj.__wbg_ptr = ptr;
        ColorCruncherBuilderFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ColorCruncherBuilderFinalization.unregister(this);
        return ptr;
    }
    ...
    */
    withMaxColors(max_colors) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.colorcruncherbuilder_withMaxColors(ptr, max_colors);
        return ColorCruncherBuilder.__wrap(ret);
    }
    /**
    * @param {number} max_colors
    ...
    */
    withTolerance(tolerance) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.colorcruncherbuilder_withTolerance(ptr, tolerance);
        return ColorCruncherBuilder.__wrap(ret);
    }
    /**
    * @param {number} tolerance
    ...
    */
    withInitializer(initializer) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.colorcruncherbuilder_withInitializer(ptr, ptr0, len0);
        return ColorCruncherBuilder.__wrap(ret);
    }
    /**
    * @param {string} initializer
    ...
    */
    withAlgorithm(algorithm) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.colorcruncherbuilder_withAlgorithm(ptr, ptr0, len0);
        return ColorCruncherBuilder.__wrap(ret);
    }
    /**
    * @param {string} algorithm
    ...
    */
    build() {
        const ret = wasm.colorcruncherbuilder_build(this.__wbg_ptr);
        return takeObject(ret);
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_colorcruncher_new = function(arg0) {
        const ret = ColorCruncher.__wrap(arg0);
    ...
    imports.wbg.__wbindgen_closure_wrapper1472 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 390, __wbg_adapter_33);
        return addHeapObject(ret);
    };
