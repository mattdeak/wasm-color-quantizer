document.addEventListener("DOMContentLoaded", () => {
  ...
  const processedImagePreview = document.getElementById(
  ...
  processBtn.addEventListener("click", async () => {
    if (uploadedImage) {
      ...
      img.onload = async function () {
        ...
        const sampleRate = getBestSampleRate(
        ...
        try {
          let cruncherBuilder = new ColorCruncherBuilder()
            .withMaxColors(numColors)
  ...
  algorithm.addEventListener("change", function () {
    algorithmWarning.style.display =
